...
/* UART ID */
#define COMM_ID_UART_0        0
#define COMM_ID_UART_1        1
#define COMM_ID_UART_2        2
#define COMM_ID_UART_3        3
...
#define MAX_COMM_1_RX_BUF_SZ      40
#define MAX_COMM_1_TX_BUF_SZ      40
